...
function bindDatatable() {
    ...
    function generateButton(data) {
        debugger
        return `<center><button onclick="Edit('${data.Id}','${data.DiscountType}','${data.PriceInvoice}','${data.PercentDiscount}','${data.DetDiscount}')" class="btn btn-warning btn-rounded btn-sm">ویرایش</button>&nbsp; <button onclick="Remove('${data.Id}')" class="btn btn-danger btn-rounded btn-sm"> حذف </button></center>`
    };
